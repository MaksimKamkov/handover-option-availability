...
import ru.mvideo.handoveroptionavailability.processor.context.brief.PickupPointsBriefProcessor;
import ru.mvideo.handoveroptionavailability.processor.context.brief.QuotasProcessor;
...
@Component
public class BriefFlow implements Flow<BriefAndPickupContext> {
	...
	private final HandoverObjectTimeZoneFilterProcessor<BriefAndPickupContext> handoverObjectTimeZoneFilterProcessor;

	private final AvailabilityOptionsProcessor<BriefAndPickupContext> availabilityOptionsProcessor;
	private final AvailabilityOptionsIndependentServiceProcessor<BriefAndPickupContext> availabilityOptionsIndependentServiceProcessor;

	private final PickupPointsBriefProcessor pickupPointsProcessor;
	...
	private final QuotasProcessor quotasProcessor;
	...
	public Mono<BriefAndPickupContext> process(BriefAndPickupContext context) {
		return callChainMain(context)
				...
				.flatMap(quotasProcessor::process)
	...
	public Mono<BriefAndPickupContext> callChainMain(BriefAndPickupContext context) {
		return Mono.zip(
				providersChain(context),
				Mono.zip(productChain(context),
				pickupHandoverObjectsChain(context)),
	...
	private Mono<BriefAndPickupContext> providersChain(BriefAndPickupContext context) {
