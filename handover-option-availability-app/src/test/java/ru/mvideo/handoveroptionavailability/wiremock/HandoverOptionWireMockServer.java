...
@Component
public class HandoverOptionWireMockServer implements BeforeEachCallback, InitializingBean {
	...
	public class MockConfiguration {
		...
		public MockConfiguration fetchHandoverOptions(String responseLocation) throws IOException {
			final var url = "/v1/provider/detail/list/id";
		...
		public MockConfiguration fetchZoneOptionHandoverOptions(String responseLocation) throws IOException {
		...
		public MockConfiguration fetchPaymentMethods(String responseLocation) throws IOException {
			final var url = "/api/private/v1/payment-methods";
			wireMockServer.stubFor(get(urlPathEqualTo(url))
					.willReturn(aResponse()
							.withStatus(OK.value())
							.withHeader(CONTENT_TYPE, APPLICATION_JSON_VALUE)
