...
@Component
public class ProductsWireMockServer implements BeforeEachCallback, InitializingBean {

  @Value("${ru.mvideo.tp.client.catalog.base-url}")
  private String host;
  ...
  public class MockConfiguration {
    ...
    public MockConfiguration fetchProducts(String responseLocation) throws IOException {
      final var url = "/api/v2/catalog-service/products";
