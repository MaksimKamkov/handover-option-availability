...
@Component
public class ObjectsPublicWireMockServer implements BeforeEachCallback, InitializingBean {

	@Value("${ru.mvideo.lards.objects-public.host}")
	private String host;
	...
	public class MockConfiguration {
		...
		public MockConfiguration fetchObjectsInfo(String responseLocation) throws IOException {
			final var url = "/api/public/v2/object/ids";
